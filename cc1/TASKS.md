...
- [x] Change FAQ hyperlinks to use product URLs (/p/) instead of category URLs (/c/) - deleted 96,020 FAQs with /c/ URLs and reset to pending for regeneration #claude-session:2025-12-21
