                    ...
                    <div class="d-flex w-100 justify-content-between align-items-start">
                        <div style="flex: 1;">
                            ...
                            <div class="content-preview">
                                ...
                                ${needsExpand ? `
                                    <button class="btn btn-sm" style="border: 1px solid #5e4a90; color: #5e4a90; background: transparent; font-size: 0.75rem; padding: 0.15rem 0.5rem;" onclick="toggleContent(${index})">
